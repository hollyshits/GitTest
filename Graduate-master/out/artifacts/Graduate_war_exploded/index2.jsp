...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    <h1><img src="images/y.jpg" class="radius-circle rotate-hover" height="50" alt="" />用户预约中心</h1>
  </div>
  <div class=" margin-big-right  margin-big-top" align="right" >
  <a class="button button-little bg-green" target="_blank"><span class="icon-user"></span>用户名:${aid}</a>
   &nbsp;&nbsp;
<!--    <a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 清除缓存</a> -->
    &nbsp;&nbsp;<a class="button button-little bg-red" href="login2.jsp">
    <span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav">
  <div class="leftnav-title"><strong><span class="icon-list"></span>菜单列表</strong></div>
  <h2><span class="icon-user"></span>我的挂号</h2>
  <ul style="display:block">
   <%--<li><a href="select.jsp" target="right"><span class="icon-caret-right"></span>挂号</a></li>  --%>

    <li><a href="history.jsp" target="right"><span class="icon-caret-right"></span>历史挂号信息</a></li>   
  
  <!--   <li><a href="column.html" target="right"><span class="icon-caret-right"></span>删除科室</a></li> -->
  </ul>   
  <h2><span class="icon-user"></span>个人信息管理</h2>
  <ul>
      <li><a href="/integrity?uid=${id}" target="right"><span class="icon-caret-right"></span>个人信誉分记录</a></li>
    <li><a href="updateUser.jsp" target="right"><span class="icon-caret-right"></span>信息修改</a></li>
  ...
  <ul>
   ...
   <!--   <li><a href="pass.html" target="right"><span class="icon-caret-right"></span>修改密码</a></li> -->
    <li><a href="./getFeedBack?pageNum=1&pageSize=2" target="right"><span class="icon-caret-right"></span>反馈评价</a></li>       
    </ul>
</div>
...
<ul class="bread">
  <li><a href="./shouye2.jsp"  class="icon-home"> 首页</a></li>
