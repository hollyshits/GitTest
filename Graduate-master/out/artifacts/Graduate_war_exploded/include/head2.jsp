...
<nav class="navbar navbar-inverse navbar-no-bg navbar-fixed-top"
	...
	<div class="container">
		...
		<div style="position: absolute; left: 150px; top: -2px;">
			<a class="navbar-brand" href="<c:url value="" />"><font color="#fff">H医院预约挂号系统</font></a>
		</div>
					...
					<div>
						<%--<c:if test="${userInfo == null}">
							<a class="navbar-brand" style="font-size: 12px;"
								href="<c:url value="" />"><strong>登录</strong></a>
							<a class="navbar-brand" style="font-size: 12px;"
								href="<c:url value="" />"><strong>注册</strong></a>
						</c:if>
						<c:if test="${userInfo.userEmail != null}">
							<c:if test="${userInfo.userIdenf == null}">
								<a class="navbar-brand" style="font-size: 12px;"
									href="<c:url value="" />"><strong>完善个人信息</strong></a>
							</c:if>
						</c:if>
						<c:if test="${userInfo.userIdenf != null}">
							...
							<a class="navbar-brand" style="font-size: 12px;"
								href="<c:url value="" />"><strong>注销</strong></a>
						</c:if>
