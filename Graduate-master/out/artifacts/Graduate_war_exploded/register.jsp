    ...
    <div class="am-g tpl-g">
        ...
        <div class="tpl-login">
            <div class="tpl-login-content">
                ...
                <form class="am-form tpl-form-line-form" method="post" action="/Graduate/RegisterServlet">
					...
					<div class="am-form-group">
                        <input type="text" class="tpl-form-input" id="user-name" name="info" required="required" placeholder="请填写个人描述">
                    </div>
                    <div class="am-form-group">
                    ...
                    <div class="am-form-group">
                        ...
                        <button type="button" onclick="location.href='login2.jsp';" class="am-btn am-btn-primary  am-btn-block tpl-btn-bg-color-success  tpl-login-btn">返回登录</button>
