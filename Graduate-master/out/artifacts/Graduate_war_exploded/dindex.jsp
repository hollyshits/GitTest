...
<div class="header bg-main">
  ...
  <a class="button button-little bg-green" target="_blank"><span class="icon-user"></span>用户名:${doc.name }</a>
   &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul>
      <li><a href="./gettodayorder?sNumber=${name}" target="right"><span class="icon-caret-right"></span>今日预约名单</a></li>
    <%--<li><a href="./getOrederByDoctor?pageNum=1&pageSize=3&sNumber=${name }" target="right"><span class="icon-caret-right"></span>预约名单</a></li>--%>
    <li><a href="./getdocSche?dNumber=${name}" target="right"><span class="icon-caret-right"></span>总预约记录单</a></li>
      <li><a href="/getdoccomment?docid=${name}&status=2" target="right"><span class="icon-caret-right"></span>评论</a></li>
    </ul>
