...
public class DepartmentController {
	...
	@RequestMapping(value = "getrecommendDepart")
	public @ResponseBody
	List<Department> getrecommendDepart(Model model) {
		List<Department> departments = departmentService.getRandomDepart();
	...
	public String getAllDepart(Model model) {
...
//	}
	...
	public String updateByid(Model model, Integer cNumber) {
	...
	public String update(@RequestParam("cNumber") Integer cNumber,
