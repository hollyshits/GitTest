...
<rapid:override name="breadcrumb">
    ...
    <nav class="breadcrumb">
        <a class="crumbs" href="/shouye.jsp">
    ...
    <div id="primary" class="content-area">
        <main id="main" class="site-main" role="main">
                ...
                <div class="entry-content">
                    ...
                    <div class="s-weixin">
                        <ul class="weimg1">
                            ...
                            <li>赶快加我聊天吧</li>--%>
                            <li><img src="/images/hospital-1.jpg"></li>
                        </ul>
                        <ul class="weimg2">
                           <%-- <li><strong>博客交流群</strong></li>
                            <li>海纳百川，大家来水</li>--%>
                            <li><img src="/images/hospital-2.jpg" alt=""></li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <footer class="single-footer">
                        <ul class="single-meta">
                            <c:if test="${sessionScope.doc!=null}">
                                <li class="edit-link">
            ...
            <div class="authorbio wow fadeInUp">
                ...
                <ul class="postinfo">
                    <li></li>
                    <li><strong>网站声明：</strong>医生信息更新与<fmt:formatDate
                    ...
                    <form id="comment_form" method="post">
                        <c:if test="${adminname!=null}">
                            <div class="user_avatar">
                                ...
                                <input type="hidden" name="commentRole" value="2">
                                <input type="hidden" name="commentAuthorName"
                                       value="${adminname}">
                                <input type="hidden" name="commentAuthorEmail"
                                       value="${doc.dTel}">
                                <input type="hidden" name="commentAuthorUrl" value="${doc.dTel}">
                            </div>
                        </c:if>
                                ...
                                <div id="div-comment-${c.commentId}" class="comment-body">
                                    <div class="comment-author vcard">
                                        ...
                                        <c:if test="${c.commentRole == 1}">
                                            ...
                                            <span class=""
                                                  style="margin-top: 2px!important;color: #c40000;font-size: 13px;;"><b>医生</b></span>
                                        </c:if>
                                        <c:if test="${c.commentRole == 2}">
                                            <i class="fa fa-black-tie" style="color: #c40000;"></i>
                                            <span class=""
                                                  style="margin-top: 2px!important;color: #c40000;font-size: 13px;;"><b>管理员</b></span>
                                        </c:if>
                                                ...
                                                <div id="div-comment-${c.commentId}" class="comment-body">
                                                    ...
                                                    <span class="comment-aux">
                                                        ...
                                                        <c:if test="${adminname!= null}">
                                                            ...
                                                            <%--<a class="comment-edit-link"
                                                               href="/commentedit?id=${c2.commentId}"
                                                               target="_blank">编辑</a>--%>
                                                        </c:if>
...
<rapid:override name="right">
    <%@include file="include/sidebar-1.jsp" %>
</rapid:override>
<%--侧边栏 end--%>
...
<%@ include file="include/framework.jsp" %>
