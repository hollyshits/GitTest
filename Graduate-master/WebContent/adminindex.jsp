        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item" lay-unselect>
                ...
                <dl class="layui-nav-child">
                    <dd lay-unselect><a ew-href="#">个人中心</a></dd>
                    <dd lay-unselect><a ew-event="psw">修改密码</a></dd>
                    <hr>
                    <dd lay-unselect><a ew-event="logout" data-url="login.jsp">退出</a></dd>
                </dl>
            </li>
            <li class="layui-nav-item" lay-unselect>
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree arrow2" lay-filter="admin-side-nav" lay-shrink="_all">
                <li class="layui-nav-item">
                    <a><i class="layui-icon layui-icon-home"></i>&emsp;<cite>信息总览</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="page/console/workplace.jsp">系统数据</a></dd>
                        <dd><a lay-href="page/console/console.jsp">预约情况</a></dd>
                        <dd><a lay-href="/admincomment">评论总览</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a><i class="layui-icon layui-icon-set"></i>&emsp;<cite>系统管理</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a lay-href="./getDepart?pageNum=1&pageSize=5">科室信息</a></dd>
                        <dd><a lay-href="page.jsp">添加科室</a></dd>
                        <dd><a lay-href="./getName">添加医生</a></dd>
                        <dd><a lay-href="./getAllDoctor?pageNum=1&pageSize=4">医生管理 </a></dd>
...
<script>
    layui.use(['index'], function () {
        ...
        // 默认加载主页
        index.loadHome({
            menuPath: 'page/console/workplace.jsp',
