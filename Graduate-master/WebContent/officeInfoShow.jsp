...
<div id="page-wrapper" style="margin-top: 50px;">
    <div id="page-inner">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="col-md-3">
                    <img alt="请检查网络，图片加载出现了一点小问题" src="/images/hospital-1.jpg">
                </div>
                <div class="col-md-4">
                    <p class="text-left">
                        <font color="#eb6864">科室名称：</font>${depart.dName}
                    </p>
                    <p class="text-left">
                        <font color="#eb6864">医生数量：</font>${depart.docnum }
                    </p>
                    <p class="text-left">
                    ...
                    <table class="table table-striped table-hover ">
                        ...
                        <c:forEach var="doc" items="${doctor }" varStatus="status">
                            <tr>
                                ...
                                <td><a onclick='appointdoc("${user.uname}","${doc.dNumber}")' <%--href="<c:url value='./getdoc?doctornum=${doc.dNumber}&uname=${user.uname}' />"--%>>${doc.name }</a></td>
                                <td>${doc.dInfo }</td>
...
<script type="text/javascript">
    function appointdoc(uname,dnumber) {
        console.log(uname)
        console.log(dnumber)
        if(uname=="") {
            console.log(111)
            ...
            location.href="./getdoc?doctornum="+dnumber+"&uname="+uname;
        }
    }
