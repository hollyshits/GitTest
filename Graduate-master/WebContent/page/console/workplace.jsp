    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                ...
                <div class="layui-card-body">
                    <p class="lay-big-font">25</p>
                    <p>总访问量<span class="pull-right">282</span></p>
                </div>
            </div>
        </div>
        <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                ...
                <div id="xiaoshou" class="layui-card-body">
                    <p class="lay-big-font"><span style="font-size: 26px;line-height: 1;">¥</span>12,000</p>
                    <p>总销售额<span class="pull-right">68 </span></p>
                </div>
            </div>
        </div>
        <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                ...
                <div id="dindan" class="layui-card-body">
        ...
        <div class="layui-col-xs12 layui-col-sm6 layui-col-md3">
            <div class="layui-card">
                ...
                <div id="usernum" class="layui-card-body">
    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-md8 layui-col-sm6">
            <div class="layui-row layui-col-space15">
                ...
                <div id="main"  style="width: 600px;height:400px;margin-left: 500px"><h3>点赞排行</h3>
                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                        <div class="layui-card-header">今日就诊进度</div>
                        <div class="layui-card-body">
                            <table class="layui-table" lay-skin="line">
                                <colgroup>
                                    <col width="40"/>
        ...
        <%--<div class="layui-col-md4 layui-col-sm6">
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-text">
                        ...
                        <script type="text/html" ew-tpl>
                            <tr>
                                <td>当前版本</td>
                                <td>v{{layui.admin.version}} &emsp; <a href="https://easyweb.vip/doc/" target="_blank">更新日志</a>
                                </td>
                            </tr>
                            <tr>
                                <td>基于框架</td>
            ...
            <div class="layui-card">
                &lt;%&ndash;<div class="layui-card-header">友情链接</div>&ndash;%&gt;
                <div class="layui-card-body">
...
$(document).ready(function() {
    $.ajax({
        url : "${pageContext.request.contextPath}/getdoctodywork",//后台请求的数据，用的是PHP
        success : function(data) {
            console.log(data);  //如果请求成功，返回数据。
            var html = ""
            for(var i=0;i<data.length;i++){
                html+="<tr><td>"+(i+1)+"</td><td><span class=\"layui-text\"><a>"+data[i].dname+"</a></span></td><td align=\"center\">"
                    +data[i].sTime+"</td><td align=\"center\">"+data[i].eTime+"</td><td align=\"center\"><span class=\"text-success\">正常</span></td><td><div class=\"layui-progress\" lay-showPercent=\"yes\"><div class=\"layui-progress-bar\" lay-percent="+data[i].percent+"></div></div></td></tr>";
            }
            $("#worksche").html(html); //在html页面id=test的标签里显示html内容
        },
    })


    $.ajax({
        url : "${pageContext.request.contextPath}/dianzan",//后台请求的数据，用的是PHP
        success : function(data) {
            console.log(data);  //如果请求成功，返回数据。
            console.log(data[1]);
            console.log(data[1].articleLikeCount);
            ...
            var option = {
                ...
                xAxis: {
                    data: [data[0].docname,data[1].docname,data[2].docname,data[3].docname,data[4].docname]
                },
                yAxis: {},
                series: [{
                    name: '点赞量',
                    type: 'bar',
                    data: [data[0].articleLikeCount,data[1].articleLikeCount, data[2].articleLikeCount, data[3].articleLikeCount, data[4].articleLikeCount]
                }]
            };
    ...
    $.ajax({
        url : "${pageContext.request.contextPath}/xiaoshou",//后台请求的数据，用的是PHP
        success : function(data) {
            console.log(data);  //如果请求成功，返回数据。
            var html = "";
            html +=" <p class=\"lay-big-font\"><span style=\"font-size: 26px;line-height: 1;\">¥</span>"+data+"</p>";
            html+=" <p>总销售额<span class=\"pull-right\">"+data+"</span></p>";
            $("#xiaoshou").html(html); //在html页面id=test的标签里显示html内容
        },
    })

    console.log(111);
            $.ajax({
                url : "${pageContext.request.contextPath}/json1",//后台请求的数据，用的是PHP
                success : function(data) {
                console.log(data);  //如果请求成功，返回数据。
                var html = "";   
                html +="<p class=\"lay-big-font\">"+data.length+"<span style=\"font-size: 24px;line-height: 1;\">位</span></p>";
                html+="<p>总用户<span class=\"pull-right\">"+data.length+"人</span></p>";
                $("#usernum").html(html); //在html页面id=test的标签里显示html内容
                },
            })
    $.ajax({
        url : "${pageContext.request.contextPath}/dindan",//后台请求的数据，用的是PHP
        success : function(data) {
            console.log(data.length);  //如果请求成功，返回数据。
            var html = "";
            html +="<p class=\"lay-big-font\">"+data.length+"</p>";
            html+="<p>"+data.length+"%<span class=\"pull-right\">60%</span></p>";
            $("#dindan").html(html); //在html页面id=test的标签里显示html内容
        },
    })
 })
</script>
